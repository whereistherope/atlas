...
assert(bootstrap.includes("const BUILD='0168r1'"),'bootstrap build must be v0.16.8-r1');
...
assert(sw.includes("atlas-shell-0.16.8-r1"),'service worker cache must be v0.16.8-r1');
...
console.log('Atlas v0.16.8 Ops refinement pass 1: PASS');
