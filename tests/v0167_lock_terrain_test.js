...
assert(bootstrap.includes("const BUILD='0169r2'"),'bootstrap build must advance with recovery inspector');
...
assert(sw.includes("atlas-shell-0.16.9-r2"),'service worker cache must advance with recovery inspector');
