...
assert.match(boot,/const BUILD='0169r68'/,'r68 build marker missing');
assert.match(sw,/atlas-shell-0\.16\.9-r68/,'r68 service-worker cache missing');
assert.match(boot,/id='atlasSimpleLoader'|host\.id='atlasSimpleLoader'/,'simple Atlas loader missing');
assert.match(boot,/copy\.textContent=progress\+'%'/,'loader percentage missing');
...
console.log('calendar weather clarity + r68 simple loader contract ok');
