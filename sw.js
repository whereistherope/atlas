...
const APP_SHELL = [
  ...
  './styles/tokens.css','./styles/app.css','./styles/widgets.css','./styles/map.css','./styles/note-editor.css','./styles/visual-note-editor.css','./styles/v0133-polish.css','./styles/editor-ux.css','./styles/atlas-document.css','./styles/capture-framework.css','./styles/command-palette.css','./styles/interaction-alignment.css','./styles/workspace-actions.css','./styles/network-layout.css','./styles/network-split.css','./styles/lock-terrain.css',
