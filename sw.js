const CACHE_NAME = 'atlas-shell-0.14.0-r1';
const APP_SHELL = [
  './','./index.html','./manifest.webmanifest',
  './styles/tokens.css','./styles/app.css','./styles/widgets.css','./styles/map.css','./styles/note-editor.css','./styles/visual-note-editor.css','./styles/v0133-polish.css','./styles/editor-ux.css','./styles/atlas-document.css',
  './js/db.js','./js/auth.js','./js/cloud-config.js','./js/cloud.js','./js/cloud-backup.js','./js/app.js','./js/cloud-restore.js','./js/relay.js','./js/relay-transport.js','./js/calendar.js','./js/map.js','./js/ui.js','./js/widgets.js','./js/v0130-safety.js','./js/cloud-sync.js','./js/cloud-sync-hotfix.js','./js/note-editor.js','./js/note-editor-loader-hotfix.js','./js/visual-note-editor.js','./js/visual-table-controls.js','./js/rich-note-capture.js','./js/project-workspace.js','./js/editor-ux.js','./js/atlas-document.js','./js/atlas-document-project-ui.js','./js/bootstrap.js',
