const CACHE_NAME = 'atlas-shell-0.16.9-r51';
const APP_SHELL = [
  './','./index.html','./manifest.webmanifest',
  './styles/tokens.css','./styles/app.css','./styles/widgets.css','./styles/map.css','./styles/v0133-polish.css','./styles/editor-ux.css','./styles/atlas-document.css','./styles/capture-framework.css','./styles/command-palette.css','./styles/interaction-alignment.css','./styles/workspace-actions.css','./styles/network-layout.css','./styles/network-split.css','./styles/lock-terrain.css','./styles/runtime-telemetry.css','./styles/theme-system.css','./styles/material-system.css','./styles/pomodoro-widget.css','./styles/item-delete-tools.css','./styles/calendar-extras.css',
